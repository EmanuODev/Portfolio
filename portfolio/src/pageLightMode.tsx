...
import About_me from "./assets/imagens/About_me.svg";
...
export function LightMode({ setPageMode }){
    return (
        <div className="h-full bg-[#F2E2BE] bg-opacity-[0.4]">
          <nav id="inicio" className="h-32 w-full flex justify-between px-12 items-center">
            ...
            <div className='flex items-center gap-10'>
              ...
              <div>
                <button onClick={() => setPageMode(false)} className='p-3 hover:bg-[#568692] rounded-full text-[30px] text-[#568692] hover:text-[#ffffff]'><MdOutlineDarkMode/></button>
              </div>
            </div>
          </nav>
          <main>
            <div className='flex w-full justify-center gap-14 items-center pb-[8rem]'>
              <div className='ml-[85px]'>
                <h1 className='font-mono text-[#568692] text-[35px] mb-4'>Escrever código é fácil...<br></br>Difícil é fazê-lo rodar.</h1>
                <div className='font-thin text-[#568692] text-[15px] mb-[50px]'>
            ...
            <div id='projetos' className='mb-24'>
              ...
              <h1 className='ml-[6rem] mb-[50px] font-semibold text-[25px] text-[#568692]'>Meus Projetos</h1>
            ...
            <div id='sobre_mim' className='pb-28'>
              ...
              <h1 className='ml-[6rem] mb-[50px] font-semibold text-[25px] text-[#568692] font'>Interesses</h1>
