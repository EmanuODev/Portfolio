...
export function LightMode(  ){
  ...
  const habilidades: habilidadesType = {
    frontend: [
      { nome: "Html", foto: "/Portfolio/fotos_skills_frontend/HTML.svg" },
      { nome: "CSS", foto: "/Portfolio/fotos_skills_frontend/CSS.svg" },
      { nome: "Tailwind", foto: "/Portfolio/fotos_skills_frontend/TailwindCSS.svg" },
      { nome: "JavaScript", foto: "/Portfolio/fotos_skills_frontend/JavaScript.svg" },
      { nome: "TypeScript", foto: "/Portfolio/fotos_skills_frontend/TypeScript.svg" },
      { nome: "React", foto: "/Portfolio/fotos_skills_frontend/React.svg" }
    ],
    backend: [
      { nome: "c", foto: "/Portfolio/fotos_skills_backend/C.svg" },
      { nome: "PHP", foto: "/Portfolio/fotos_skills_backend/PHP.svg" },
      { nome: "Laravel", foto: "/Portfolio/fotos_skills_backend/Laravel.svg" },
      { nome: "Java", foto: "/Portfolio/fotos_skills_backend/Java.svg" },
      { nome: "Spring", foto: "/Portfolio/fotos_skills_backend/Spring.svg" },
      { nome: "Python", foto: "/Portfolio/fotos_skills_backend/Python.svg"}
    ],
    outros: [
      { nome: "MySQL", foto: "/Portfolio/fotos_skills_outros/MySQL.svg" },
      { nome: "Docker", foto: "/Portfolio/fotos_skills_outros/Docker.svg" }
    ]
  };
  ...
  const projetos: projetosType[] = [
    ...
    { 
      ...
      foto: '/Portfolio/fotos_projetos/foto_imovel.png',
    ...
    { 
      ...
      foto: '/Portfolio/fotos_projetos/foto_esportes.png',
    ...
    { 
      ...
      foto: '/Portfolio/fotos_projetos/foto_portfolio.png',
    ...
    { 
      ...
      foto: '/Portfolio/fotos_projetos/foto_academic.png',
    ...
    },
    {
      ...
      foto: '/Portfolio/fotos_projetos/foto_puzzle.png',
